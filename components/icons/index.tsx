...
/* ── Bundle page icons ──────────────────────────────────────────────────────
 * Same Lucide set the legacy configurator used, so the visual language carries
 * over: Package on "Build Your Bundle", Info on "About This Bundle", Sparkles
 * on the benefits list, ChefHat on "Quick Prep Ideas", TrendingDown on "Smart
 * Shopping Math", Gift on "What's Included", HelpCircle on the FAQ.
 */
...
/* ── About page icons (legacy Lucide set) ───────────────────────────────── */
...
export function HeartHandshakeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" />
...
/* ── Contact page icons (legacy Lucide set; X and WhatsApp are brand marks) ─ */
...
/** The X (formerly Twitter) logo — a filled brand mark, not a stroke icon. */
...
/* ── Product detail icons (legacy Lucide set) ───────────────────────────── */
...
/* ── Policy page icons (legacy Lucide set) ──────────────────────────────── */
